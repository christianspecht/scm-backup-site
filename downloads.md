...
Note that AppVeyor deletes artifacts older than six months *(as stated in their [Artifacts retention policy](https://www.appveyor.com/blog/2018/06/05/artifacts-retention-policy-update/))*, so all non-release builds will be kept for six months only.
